...
Core Maintainers and Maintainers are listed in the main goose repository's [MAINTAINERS.md](https://github.com/yixuanzhong/caros/blob/main/MAINTAINERS.md) file with their areas of expertise where applicable.
