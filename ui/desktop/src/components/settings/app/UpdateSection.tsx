...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, Caros will notify you of new versions but will not download them automatically.',
  },
  ...
  autoDownload: {
    ...
    defaultMessage:
      'Caros will download the update in the background and install it the next time you quit or restart.',
  },
  manualInstallNote: {
  ...
  readyInstallAuto: {
    ...
    defaultMessage:
      "✓ Update is ready. Restart Caros to finish installing it, or quit when you're done.",
  },
  installNowHint: {
