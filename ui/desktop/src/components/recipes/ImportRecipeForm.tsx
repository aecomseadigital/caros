...
const i18n = defineMessages({
  ...
  deeplinkPlaceholder: {
    ...
    defaultMessage: 'Paste your caros://recipe?config=... deeplink here',
  },
  deeplinkHint: {
    id: 'importRecipeForm.deeplinkHint',
    defaultMessage: 'Paste a recipe deeplink starting with "caros://recipe?config="',
  },
  or: {
  ...
  reviewWarning: {
    ...
    defaultMessage: 'Ensure you review contents of recipe files before adding them to your caros interface.',
  },
  cancel: {
...
const importRecipeSchema = z
  .object({
    deeplink: z
      .string()
      .refine(
        (value) => !value || value.trim().startsWith('caros://recipe?config='),
        'Invalid deeplink format. Expected: caros://recipe?config=...'
      ),
    recipeUploadFile: z
      .instanceof(File)
      .nullable()
