...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'caros is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'caros is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'caros is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'caros is compacting the conversation...',
  },
  idle: {
