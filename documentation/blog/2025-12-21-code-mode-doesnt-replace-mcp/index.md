...
- [Better UX](https://github.com/yixuanzhong/caros/pull/6205) - showing what tools are being called instead of raw JavaScript
- [Better reliability](https://github.com/yixuanzhong/caros/pull/6177) - improving type signatures so LLMs get the code right the first time
- [More capabilities](https://github.com/yixuanzhong/caros/pull/6160) - enabling subagents to work inside Code Mode
