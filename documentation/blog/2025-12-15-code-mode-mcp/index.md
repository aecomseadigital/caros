...
* Try out the feature by enabling the ["Code Mode" extension](https://github.com/yixuanzhong/caros/blob/main/crates/goose/src/agents/platform_extensions/code_execution.rs) in v1.17.0 or later of goose by clicking extensions on the left side of the desktop app or running `goose configure` on cli
