...
The Fetch extension [does not work](https://github.com/yixuanzhong/caros/issues/1184) with Google models (e.g. gemini-2.0-flash) because this extension uses `format: uri` in its JSON schema which Google doesn't support.
:::
