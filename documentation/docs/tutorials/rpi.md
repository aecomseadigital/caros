...
```sh
mkdir -p ~/.config/caros/recipes/subrecipes

curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/rpi-research.yaml -o ~/.config/caros/recipes/rpi-research.yaml
curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/rpi-plan.yaml -o ~/.config/caros/recipes/rpi-plan.yaml
curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/rpi-implement.yaml -o ~/.config/caros/recipes/rpi-implement.yaml
curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/rpi-iterate.yaml -o ~/.config/caros/recipes/rpi-iterate.yaml

curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/subrecipes/rpi-codebase-locator.yaml -o ~/.config/caros/recipes/subrecipes/rpi-codebase-locator.yaml
curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/subrecipes/rpi-codebase-analyzer.yaml -o ~/.config/caros/recipes/subrecipes/rpi-codebase-analyzer.yaml
curl -sL https://raw.githubusercontent.com/yixuanzhong/caros/main/documentation/src/pages/recipes/data/recipes/subrecipes/rpi-pattern-finder.yaml -o ~/.config/caros/recipes/subrecipes/rpi-pattern-finder.yaml
```
</details>
...
This command invokes the **[RPI Research Codebase](https://raw.githubusercontent.com/yixuanzhong/caros/refs/heads/main/documentation/src/pages/recipes/data/recipes/rpi-research.yaml)** recipe, whose job is very strict:
...
The **[RPI Create Plan](https://raw.githubusercontent.com/yixuanzhong/caros/refs/heads/main/documentation/src/pages/recipes/data/recipes/rpi-plan.yaml)** recipe starts by reading the research document goose created.
...
Definitely not a fast process. BUT! When I put up [this PR](https://github.com/yixuanzhong/caros/pull/6250), the build passed and the separate Code Review Agent didn't have a single comment. That's just how well done the work was.
