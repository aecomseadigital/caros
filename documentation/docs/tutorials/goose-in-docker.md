...
To begin, you will need to modify the [`Dockerfile` and `docker-compose.yml` files](https://github.com/yixuanzhong/caros/tree/main/documentation/docs/docker) to suit your requirements. Some changes you might consider include:
