...
:::info
goose supports Tools, Resources, and Prompts from the [Model Context Protocol](https://modelcontextprotocol.io/). See [`mcp_client.rs`](https://github.com/yixuanzhong/caros/blob/main/crates/goose/src/agents/mcp_client.rs) for the supported protocol version and client capabilities.
:::
...
- [goose's implementation](https://github.com/yixuanzhong/caros/blob/main/crates/goose/src/agents/mcp_client.rs) currently supports text and image content types
