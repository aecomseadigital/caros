...
Validation rules from [`validate_recipe.rs`](https://github.com/yixuanzhong/caros/blob/main/crates/goose/src/recipe/validate_recipe.rs) are enforced when loading recipes and used by the [`goose recipe validate`](/docs/guides/goose-cli-commands#recipe) subcommand:
