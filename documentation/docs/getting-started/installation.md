  ...
  <TabItem value="mac" label="macOS" default>
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="goose CLI">
        ...
        ```sh
        curl -fsSL https://github.com/yixuanzhong/caros/releases/download/stable/download_cli.sh | CONFIGURE=false bash
        ```
    ...
    <Tabs groupId="interface">
      ...
      <TabItem value="cli" label="goose CLI">
        ...
        **PowerShell Installation: Standard**
        ...
        ```powershell
        Invoke-WebRequest -Uri "https://raw.githubusercontent.com/yixuanzhong/caros/main/download_cli.ps1" -OutFile "download_cli.ps1";
        ```
...
This creates ROFF-formatted manpages in `target/man/` (e.g., `caros.1`, `caros-session.1`) that can be installed to `/usr/share/man/man1/` to provide offline documentation via the `man` command.

Manpage generation requires the goose source repository and is intended for distribution packagers preparing packages for Fedora, Debian, and other Linux distributions. See the [generate_manpages.rs source](https://github.com/yixuanzhong/caros/blob/main/crates/goose-cli/src/bin/generate_manpages.rs) for implementation details.
