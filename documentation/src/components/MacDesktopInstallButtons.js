    ...
    <div>
      ...
      <div className="pill-button" style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
        <Link
          ...
          to="https://github.com/yixuanzhong/caros/releases/download/stable/Goose.zip"
        >
          <IconDownload /> macOS Silicon
        </Link>
        <Link
          className="button button--primary button--lg"
          to="https://github.com/yixuanzhong/caros/releases/download/stable/Goose_intel_mac.zip"
        >
