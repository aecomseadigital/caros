      ...
      <div className="card max-w-xl">
        ...
        <div className="card__body text--center">
          ...
          <div className="text-sm">
            ...
            <Link href="https://github.com/yixuanzhong/caros">GitHub</Link>, helping others on{' '}
            <Link href="https://discord.gg/goose-oss">Discord</Link>, or share your 
            goose projects with the community! You can check out the{' '}
            <Link href="https://github.com/yixuanzhong/caros/blob/main/CONTRIBUTING.md">contributing guide</Link>{' '}
            for more tips.
          </div>
        </div>
      </div>
