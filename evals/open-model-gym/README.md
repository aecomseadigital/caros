...
- `goose` — [Goose](https://github.com/yixuanzhong/caros) agent framework
...
[Goose](https://github.com/yixuanzhong/caros) is an open-source coding agent with built-in MCP support.
